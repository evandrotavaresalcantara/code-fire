...
test('Deve obter os perfis com suas respectivas permissões', async () => {
    ...
    const repo = new RepositorioPerfilMock([novoPerfil1, novoPerfil2, novoPerfil3])
    const repoPermissao = new RepositorioPermissaoMock([novaPermissao1, novaPermissao2, novaPermissao3, novaPermissao4])
